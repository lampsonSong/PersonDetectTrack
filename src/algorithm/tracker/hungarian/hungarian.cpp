...
//
// --------------------------------------------------------------------------
float AssignmentProblemSolver::Solve(const distMatrix_t &distMatrixIn,
...
void AssignmentProblemSolver::assignmentoptimal(
    assignments_t &assignment, float &cost, const distMatrix_t &distMatrixIn,
    size_t nOfRows, size_t nOfColumns) {
...
void AssignmentProblemSolver::computeassignmentcost(
    const assignments_t &assignment, float &cost,
...
void AssignmentProblemSolver::step2a(assignments_t &assignment,
                                     float *distMatrix, bool *starMatrix,
...
void AssignmentProblemSolver::step2b(assignments_t &assignment,
  ...
  if (nOfCoveredColumns == minDim) {
    ...
    /* move to step 3 */
    step3_5(assignment, distMatrix, starMatrix, newStarMatrix, primeMatrix,
            coveredColumns, coveredRows, nOfRows, nOfColumns, minDim);
  }
}
...
//
// --------------------------------------------------------------------------
void AssignmentProblemSolver::step3_5(assignments_t &assignment,
                                      float *distMatrix, bool *starMatrix,
                                      bool *newStarMatrix, bool *primeMatrix,
                                      bool *coveredColumns, bool *coveredRows,
                                      size_t nOfRows, size_t nOfColumns,
